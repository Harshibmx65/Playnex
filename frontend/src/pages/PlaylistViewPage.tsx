          ...
          <div className={`grid ${creatorChapters.length > 0 ? 'grid-cols-5' : 'grid-cols-4'} gap-1 p-1 bg-slate-100 dark:bg-[#080d1a] rounded-2xl border border-slate-300 dark:border-white/[0.08] mb-4 shrink-0 font-sans`}>
            {creatorChapters.length > 0 && (
              <button
                ...
                className={`flex items-center justify-center gap-1.5 py-2 px-1 rounded-xl text-xs font-bold transition-all ${activeTab === 'chapters'
                  ? 'bg-cyan-500 dark:bg-[#00e5ff] text-black shadow-sm'
                  : 'text-cyan-900 dark:text-[#00e5ff] hover:text-slate-950 dark:hover:text-white font-bold'
                  }`}
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1.5 py-2 px-1 rounded-xl text-xs font-bold transition-all ${activeTab === 'notes'
                ? 'bg-cyan-500 dark:bg-[#00e5ff] text-black shadow-md'
                : 'text-slate-800 dark:text-slate-200 hover:text-slate-950 dark:hover:text-white hover:bg-white/60 font-bold'
                }`}
            >
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1.5 py-2 px-1 rounded-xl text-xs font-bold transition-all ${activeTab === 'doubts'
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1.5 py-2 px-1 rounded-xl text-xs font-bold transition-all ${activeTab === 'tags'
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1.5 py-2 px-1 rounded-xl text-xs font-bold transition-all ${activeTab === 'revision'
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative min-w-[200px] flex-1 sm:flex-initial">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 bg-white dark:bg-[#0c1426] border-2 border-slate-300 dark:border-white/[0.08] rounded-xl text-xs text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-cyan-500 shadow-sm font-medium"
              />
            </div>
            ...
            <div className="flex items-center gap-1 bg-slate-100 dark:bg-[#0c1426] p-1 rounded-xl border border-slate-300 dark:border-white/[0.08] text-xs font-mono shadow-sm">
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all font-bold ${statusFilter === 'ALL' ? 'bg-cyan-500 dark:bg-[#00e5ff] text-black shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'
                  }`}
              >
                All
              </button>
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all font-bold ${statusFilter === 'COMPLETED' ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'
                  }`}
              >
                Done
              </button>
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all font-bold ${statusFilter === 'DOUBT' ? 'bg-rose-500 text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'
                  }`}
              >
                Doubts
              </button>
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all font-bold ${statusFilter === 'REVISION' ? 'bg-amber-500 text-black shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'
                  }`}
              >
                Revise
              </button>
          ...
          {filteredVideos.map((vid: Video) => {
            ...
            return (
              <div
                ...
                className={`p-3.5 rounded-2xl cursor-pointer transition-all duration-200 flex items-start gap-3 border-2 ${isSelected
              ...
              >
                ...
                <div className="relative w-24 aspect-video rounded-xl overflow-hidden bg-slate-900 dark:bg-[#080d1a] shrink-0 border border-slate-300 dark:border-white/10">
                  ...
                  <span className="absolute bottom-1 right-1 px-1.5 py-0.5 bg-black/90 rounded font-mono text-[11px] font-bold text-white border border-white/20">
                  ...
                  <div className="flex items-center gap-2 pt-0.5 text-xs font-mono">
                    ...
                    {vid.notes_count > 0 && (
                      <span className="text-slate-800 dark:text-slate-200 font-bold flex items-center gap-0.5">
                        <BookOpen className="w-3.5 h-3.5 text-cyan-600 dark:text-[#00e5ff]" />
