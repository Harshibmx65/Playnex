...
class Settings(BaseSettings):
    ...
    API_V1_STR: str = "/api"
    SECRET_KEY: str = "super-secret-jwt-key-for-playlist-manager-production-grade"
    ALGORITHM: str = "HS256"
    ...
    SMTP_SSL: bool = os.getenv("SMTP_SSL", "False").lower() in ("true", "1", "t")
    EMAILS_FROM_EMAIL: str = os.getenv("EMAILS_FROM_EMAIL", "noreply@playnex.com")
    EMAILS_FROM_NAME: str = os.getenv("EMAILS_FROM_NAME", "Playnex")
